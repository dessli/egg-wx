...
module.exports = app => {
  ...
  class ApiPay {
    ...
    async createUnifiedorderXml(attach, body, notify_url, openid, out_trade_no, total_fee, spbill_create_ip, mode = 'miniapp', other = {}) {
      ...
      let baseData = { appid, attach, body, notify_url, openid, out_trade_no, total_fee, spbill_create_ip, trade_type, ...other };
      baseData.nonce_str = utils.getRandomStr(16);
      baseData.mch_id = app.config.wx.mch_id;
      let sortBaseDataKeys = Object.keys(baseData).sort();
      let signString = ''
